    ...
    <div class="my-profile page-container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row no-gutters justify-content-between align-items-end">
                    <div class="profile">
                        <div class="name">Narendra Chauhan</div>
                        <div class="email">narendra@gmail.com</div>
                        <div class="phone">8932835531</div>
                        <div class="college">SCRIET CCSU MEERUT U.P. INDIA</div>
                    </div>
                    <div class="edit">
                        <div class="edit-profile">Edit Profile</div>
                    </div>
